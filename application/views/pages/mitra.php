<div class="container-fluid">
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                <div class="card-header text-center m-3 border-bottom">
                ...
                <div class="card-body pl-5 pr-5 pb-5">
                    <p class="">Poin Saya <span class="text-warning pull-right"> 5000</span></p>
                    <p class="">Kupon Saya <span class="text-warning pull-right"> 3000</span></p>
                    <div class="dropdown-divider mb-4"></div>
                    <a class="btn btn-primary btn-block mb-4" href="#">Pengaturan Akun</a>
                    <a class="btn btn-primary btn-block" href="#">Keluar</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-header card-header-primary">
                    <p class="lead text-center">Mitra</p>
                </div>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item border-top border-bottom dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#"><i class="material-icons">hourglass_empty</i> Menunggu</a>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top"
                                ...
                                alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Barang Baru <span
                                        class="badge badge-warning float-right text-primary">Recomended</span></h5>
                                <h6 class="card-subtitle mb-2 mt-2 text-muted  font-weight-bold lead">Rp-,9000</h6>
                                <p class="card-text">Some quick example text to build on the card title and make up
                                    the bulk of the
                                    card's content.</p>
                                <a href="#" class="btn btn-info"><i class="material-icons">info</i> Detail</a>
                                <a href="#" class="btn btn-danger"><i class="material-icons">add_shopping_cart</i>
                                    Beli</a>
                            </div>
